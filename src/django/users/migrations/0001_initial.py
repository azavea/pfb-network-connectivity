# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2017-02-15 22:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org_type', models.CharField(choices=[('ADMIN', 'PFB Administrator Organization'), ('AREA', 'Area'), ('SUBSCRIBER', 'Subscriber')], max_length=10)),
                ('area', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='pfb_network_connectivity.Area')),
