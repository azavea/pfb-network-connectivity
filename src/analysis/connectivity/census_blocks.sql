...
ALTER TABLE neighborhood_census_blocks DROP COLUMN IF EXISTS doctors_ratio;
...
ALTER TABLE neighborhood_census_blocks DROP COLUMN IF EXISTS dentists_ratio;
...
ALTER TABLE neighborhood_census_blocks DROP COLUMN IF EXISTS hospitals_ratio;
...
ALTER TABLE neighborhood_census_blocks DROP COLUMN IF EXISTS pharmacies_ratio;
...
ALTER TABLE neighborhood_census_blocks DROP COLUMN IF EXISTS transit_ratio;
...
ALTER TABLE neighborhood_census_blocks ADD COLUMN doctors_ratio FLOAT;
...
ALTER TABLE neighborhood_census_blocks ADD COLUMN dentists_ratio FLOAT;
...
ALTER TABLE neighborhood_census_blocks ADD COLUMN hospitals_ratio FLOAT;
...
ALTER TABLE neighborhood_census_blocks ADD COLUMN pharmacies_ratio FLOAT;
...
ALTER TABLE neighborhood_census_blocks ADD COLUMN transit_ratio FLOAT;
