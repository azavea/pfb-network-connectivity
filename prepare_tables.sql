...
ALTER TABLE cambridge_ways ADD COLUMN ft_cross_lanes INT;
ALTER TABLE cambridge_ways ADD COLUMN tf_cross_lanes INT;
ALTER TABLE cambridge_ways ADD COLUMN twltl_cross_lanes INT;
