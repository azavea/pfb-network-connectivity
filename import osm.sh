# vars
OSMPREFIX='cambridge'
OSMFILE='/home/spencer/gis/boston_massachusetts.osm'

# drop old tables
psql -h 192.168.40.225 -U gis -d people_for_bikes \
...
osm2pgsql \
  ...
  --port 5432 \
  --create \
  --database people_for_bikes \
  --prefix ${OSMPREFIX}_osm_full \
  --proj 2249 \
  --style /home/spencer/dev/pfb/pfb.style \
  /home/spencer/gis/boston_massachusetts.osm
